...
public class Practica01_01_b extends JFrame {
	...
	public Practica01_01_b() {
		...
		// Pestaña 1: Panel normal
		contentPane.add("Pestaña 1", new JPanel());
		
		// Pestaña 2: ScrollPane con barras siempre visibles
		...
		// Pestaña 3: DesktopPane (para aplicaciones MDI)
		JDesktopPane desktopPane = new JDesktopPane();
		contentPane.addTab("Pestaña 3", null, desktopPane, null);
		
		// Pestaña 4: InternalFrame dentro de la pestaña
