...
public class InicializadorDatos {
    ...
    public static void cargarTodo(ListaProductos inventario) {
        ...
        // PANADERÍA
        lista.add(new PanaderiayTortilleria("PT01", "Pan Caja", 48.0, 25, "img/pan.jpg"));
        lista.add(new PanaderiayTortilleria("PT02", "Concha", 12.0, 40, "img/concha.jpg"));
        lista.add(new PanaderiayTortilleria("PT03", "Bolillo", 2.5, 100, "img/bolillo.jpg"));
        lista.add(new PanaderiayTortilleria("PT04", "Tortilla", 22.0, 60, "img/tortilla.jpg"));
        lista.add(new PanaderiayTortilleria("PT05", "Dona", 15.0, 30, "img/dona.jpg"));
        ...
        // MASCOTAS
        lista.add(new Mascotas("MA01", "Croquetas", 180.0, 10, "img/perro.jpg"));
        lista.add(new Mascotas("MA02", "Sobre Gato", 12.5, 40, "img/gato.jpg"));
        lista.add(new Mascotas("MA03", "Arena", 145.0, 8, "img/arena.jpg"));
        lista.add(new Mascotas("MA04", "Juguete", 55.0, 15, "img/jueg.jpg"));
        lista.add(new Mascotas("MA05", "Collar", 85.0, 12, "img/collar.jpg"));
